...
altoMusic = \relative c' {
  ...
  r2 bes8[(c)] d4 d, d g g g(d2) r4
  r2 g4 g es g d(g) fis r r2
  fis4 g g f f2.(c4~c) r r2
  g'4 a f bes bes2(g4 c, d) r r2 
  f4 f f a d,(g) a r
  r2 g4 g8[(f)] e[(d)] d4 ees8[(c)] a4 b r r2 r1 r
}
VerseOne = \lyricmode {
  Now I know you | shall me qui -- | et |
  my con -- science which | tor -- ments me |
  Your faith -- | ful love will ful -- | fill |
  what you | your -- self have | said |
  that on this wide | Earth |  |
  no one shall be   | lost  |  |
  but shall live for | ev -- er |
